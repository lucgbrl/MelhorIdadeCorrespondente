    ...
    <div class = "row">
        ...
        <div class = "col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <form class="" action="cad_produto.php" method="post">
                  <select class="form-control" name="loja">
                    <option value="1">Selecione um Corretor</option>
                    <?php
                      ...
                      while($row = mysqli_fetch_array($result)){
                        ?>
                        <option value="<?=$row['id_fun'];?>" class = "form-control"><?=$row['nome_fun'];?></option>
                    <?php
                      }
                    ?>
                  </select>
            ...
            <div class = "card">
                ...
                <div class = "card-body">
                    <h3><i class = "fa fa-address-card"></i> Cadastrar Contrato de Empréstimo</h3>
                    <hr>
                    <b>Versão 1.1</b>
                    <br><br>
                    ...
                    <!--form action = "cad_produto.php" method = "post"-->
                        ...
                        <div class = "input-group mb-3">
                            <label for="cpf_cli" class = "form-control col-md-3">Benefício  </label>
                            <input type="text" class = "form-control" name = "benefício_cli">
                        </div>
                        <div class = "input-group mb-3">
                            <label for="cpf_cli" class = "form-control col-md-3">Banco</label>
                            <input type="text" class = "form-control" name = "benefício_cli">
                        </div>
                        <div class = "input-group mb-3">
                            <label for="cpf_cli" class = "form-control col-md-3">Conta</label>
                            <input type="text" class = "form-control" name = "benefício_cli">
                        </div>
                        <!-- Numérico -->
                        <div class = "input-group mb-3">
