...
CREATE TABLE `tab_clientes` (
  ...
  `nomeCliente` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL,
  `sexoCliente` varchar(20) DEFAULT NULL,
  `data_Cliente` date DEFAULT NULL,
  `enderecoCliente` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL,
  `rgCliente` varchar(20) DEFAULT NULL,
  `cpCliente` varchar(20) DEFAULT NULL,
  `estadoCivil` varchar(20) DEFAULT NULL,
...
CREATE TABLE `tab_contratos` (
  ...
  `data_Cliente` date DEFAULT NULL,
  `enderecoCliente` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL,
  `rgACliente` varchar(20) DEFAULT NULL,
...
CREATE TABLE `tab_lojas` (
  `idLoja` int(11) NOT NULL,
  `nomeLoja` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL,
  `enderecoLoja` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `status` varchar(10) DEFAULT NULL,
  `data_cadastro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `data_alteracao` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
